...
| `tpu-proxy-v4.0.0.patch` | `v4.0.0-jito`, `v4.0.1-jito` |
...
cd jito-solana
git checkout tags/v4.0.1-jito         # or your target version
git apply tpu-proxy-v4.0.1.patch      # use the matching patch
```
